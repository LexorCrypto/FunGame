...
| Интервал топота Пессимарио (§7.5) | 5.0 s | Не задан |
...
| Кадансы атак внутри окон Трона (§7.6) | как у боссов-владельцев атак | §7.6 задаёт длину окна, не каданс внутри него |
