...
Выпадение: 20% шанс из убитого **пикирующего** врага (70% выстрел / 30% щит).
...
только падает, вверх не идёт). До 2026-07-25 было 8% / 60-40 и сквозное падение
за нижний край поля — дроп оказывался недостижим; изменено по решению владельца.
