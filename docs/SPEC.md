...
.........KKKKKKKKKKKKKK.........
```
Кадр B: строка 16 → `......KWKKWPBBBBBBBBPWKKWK......` (блик воды).
...
.......KKKKK........KKKKK.......
```
Кадр B: строка 9 → `.........KNnnKKKKKKnnNK.........` (рот открыт при броске).
...
```
Кадр B: строки 6–7 (глаза) сдвинуть на 1 px вправо.
...
```
Кадр B: строки 10–11 (ноги) сдвинуть на 1 px влево.
...
.........KKKKKKKKKKKKKK.........
```
Кадр B: строка 16 → `......KYKKYFFPFFFFFPFYKKYK......` (сияние самоцвета).
