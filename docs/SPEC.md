...
Приёмочная метрика — по декодеру браузера, а не по файлу: `decodeAudioData`,
затем длина тихого хвоста + тихого начала = разрыв петли. Норма — единицы
миллисекунд; текущие значения: title 8.1 ms (29.481 s), battle 12.2 ms
(42.683 s), boss 11.3 ms (39.967 s, обрезки не потребовал), скачок амплитуды
на стыке ≤ 0.00015 из 1.0. Номиналы в таблице — параметр генерации, не
приёмочное значение.
