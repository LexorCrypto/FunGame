// SPEC §8: пауэр-ап выпадает из убитого пикирующего врага (30% шанс,
// 70% выстрел / 30% щит). Падает 60 px/s и ЗАМИРАЕТ в зоне игрока (§1),
// где подбирается касанием; висит 6.0 s, последние 1.5 s мигает, затем
// пропадает. Тип: 'shot' (двойной выстрел) | 'shield'.
//
