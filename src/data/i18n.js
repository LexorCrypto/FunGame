...
const STRINGS = {
  ru: {
    ...
    crawl_1: 'Галактика ПИССУАРИУС пала за одну ночь. Из Канализационного рукава хлынула армада живой сантехники: тараканы-камикадзе, ходячие какахи и туалеты в броне из трёх слоёв фаянса. Но первым до обитаемых систем дошёл не флот вторжения. Первым дошёл ЗАПАХ.',
    ...
    crawl_3: 'Галактический флот капитулировал за девять минут: акт о сдаче адмиралы подписали, зажимая носы. Уцелел один пилот — ПИССУАР-1. Он родился без обоняния и всю жизнь считал это диагнозом. Сегодня это единственное оружие, которое ещё работает. Один против армады нечистот. Он не герой — он просто не чувствует, во что летит.',
  ...
  en: {
    ...
    crawl_1: 'The galaxy PISSUARIUS fell in a single night. Out of the Sewer Arm poured an armada of living plumbing: kamikaze roaches, walking poops and toilets armored in three layers of porcelain. But the invasion fleet was not the first thing to reach the inhabited systems. The SMELL was.',
    ...
    crawl_3: 'The galactic fleet capitulated in nine minutes: the admirals signed the surrender holding their noses. One pilot was left — PISSUAR-1. He was born with no sense of smell and spent his whole life calling it a defect. Today it is the only weapon that still works. One man against an armada of filth. He is no hero — he simply cannot smell what he is flying into.',
