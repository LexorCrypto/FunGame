...
M1–M9 и задачи FUN-1…FUN-31, все Done. История там, **по умолчанию новые задачи туда не
заводим** — живой трекер выше. Исключение — явная команда владельца вести конкретную
работу атомарными задачами Linear: так 2026-07-26 под
[issue #1](https://github.com/LexorCrypto/FunGame/issues/1) появились FUN-27…FUN-31 сверх
майлстоунов M1–M9, а итог всё равно писался в GitHub Issue. Без такой команды в Linear
не пишем. Приёмка по-прежнему по SPEC §16.
